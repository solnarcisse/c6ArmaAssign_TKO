...
#TGW----------------
resource "aws_ec2_transit_gateway_route_table" "TGW-RTB-HONG-KONG-VPC-1-PROD" {
  transit_gateway_id = aws_ec2_transit_gateway.HK_myApp_TGW.id

  tags = {
    "name" = "TGW-RTB-HONG-KONG-VPC-1-PROD"
  }
}

resource "aws_ec2_transit_gateway_route" "TGW-RTB-HONG-KONG-VPC-1-A-Route1" {
  destination_cidr_block         = "10.0.0.0/16"
  transit_gateway_attachment_id  = aws_ec2_transit_gateway_vpc_attachment.TGA-HK.id
  transit_gateway_route_table_id = aws_ec2_transit_gateway_route_table.TGW-RTB-HONG-KONG-VPC-1-PROD.id
}
